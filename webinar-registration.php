...
<div class="card-group">
    <div class="card mr-3 border-0 shadow-none">
        <div class="card py-2">
                ...
                <div class="card-body">
                <form action="https://app4.easysendy.com/lists/hm6266kg3x081/subscribe" accept-charset="utf-8" class="form" role="form" autocomplete="off" id="formRegistration" novalidate="" method="POST">
                                    <div class="form-group">
                                        <label for="fname">Full Name</label>
                                        <input type="text" class="form-control form-control-lg rounded-0" name="FULLNAME" id="fullName" required="">
                                        <div class="invalid-feedback">Oops, you missed this one.</div>
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="email" class="form-control form-control-lg rounded-0" id="EMAIL" required="" autocomplete="new-email" name="EMAIL">
                                        <div class="invalid-feedback">Enter your correct email address</div>
                                    </div>
                                    <button type="submit" class="btn text-light bg-avc border-0 btn-lg w-100" id="btnLogin">Register</button>
                    </form>
                </div>
            
        </div>
    </div>
    <div class="col-6 ml-3 border-0 shadow-none">
        <div class="mx-2 py-2">
            <p>
